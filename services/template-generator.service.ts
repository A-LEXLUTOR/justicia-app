...
// import { generateCompletion } from './llama-api.services'; // Commenté pour le build
...
DOCUMENT:`;
    ...
    try {
        ...
        //     max_tokens: 2000
        // });
        const generatedContent = fullPrompt; // Stub temporaire pour le build
...
RÉPONSE (JSON uniquement, sans explication):`;
    ...
    try {
        ...
        //     max_tokens: 1000
        // });
        const response = '{}'; // Stub temporaire pour le build
