...
const Sidebar: React.FC<SidebarProps> = ({ sessions, folders, activeSessionId, isExpanded, onNewChat, onSwitchSession, onDeleteSession, onRenameSession, onCreateFolder, onRenameFolder, onDeleteFolder, onToggleFolderExpansion, onMoveSessionToFolder, onToggle, user, onLogout, isMobile, onShowAnalytics, onShowHistory, onShowVoiceChat, onShowReportGenerator, onShowDocumentEditor, onShowRAGSpace, onShowShare, onShowAccount, onShowSettings }) => {
    return (
        <>
            {/* Overlay for mobile */}
            <div
