...
const FlagCard: React.FC<{ flag: Flag }> = ({ flag }) => {
    ...
    const handleListenClause = () => {
        if (isSpeakingClause) {
            ...
            speakTextWithOpenAI(flag.clause, () => setIsSpeakingClause(false), 'nova');
    ...
    const handleListenExplanation = () => {
        if (isSpeakingExplanation) {
            ...
            speakTextWithOpenAI(flag.explanation, () => setIsSpeakingExplanation(false), 'nova');
            ...
            {flag.suggestedRewrite && (
                <div className="mt-4 p-3 bg-justicia-gradient/10 border-l-4 border-justicia-gradient rounded">
                    <div className="flex items-center gap-2 mb-1">
                        <span className="text-justicia-gradient text-lg">💡</span>
...
const AnalysisResultsView: React.FC<AnalysisResultsViewProps> = ({ results, fullText, analyticsOpen, onCloseAnalytics, historyOpen, onCloseHistory, activeSessionId }) => {
    ...
    //         setIsSpeaking(false);
    //     } else {
    //         speakTextWithOpenAI(getFullAnalysisText(), () => setIsSpeaking(false), 'nova');
    //         setIsSpeaking(true);
    //     }
    // };
    ...
    return (
        <div className="max-w-7xl mx-auto p-6">
            <div className="flex flex-row-reverse items-center justify-between mb-4 gap-3">
                ...
                <h3 className="text-xl font-bold text-white flex-1">Analyse de : <strong className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 via-pink-400 to-orange-400">{detectedType}</strong></h3>
            </div>
            ...
            <div className="flex flex-row gap-6 w-full">
                ...
                <div className="flex-1 w-[70%] space-y-6">
                    ...
                    >
                        <div className="text-neutral-300 leading-relaxed flex-1 prose prose-invert prose-sm max-w-none">
            ...
            {/* Boutons supprimés selon la demande de l'utilisateur */}
