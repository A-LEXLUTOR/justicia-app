...
const DocumentInfographics: React.FC<DocumentInfographicsProps> = ({ results }) => {
  ...
  return (
    <div className="flex flex-col gap-8 w-full max-w-full my-8 overflow-hidden">
      {/* --- Density Heatmap FIRST --- */}
      <div className="bg-neutral-900 rounded-xl p-6 shadow-lg w-full max-w-full overflow-hidden">
