...
export const SimpleRAGUpload: React.FC<SimpleRAGUploadProps> = ({ onAnalysisComplete }) => {
    ...
    return (
        <div className="flex justify-center items-center mb-6">
            <div className="bg-gradient-to-br from-purple-900/20 to-blue-900/20 border border-purple-500/30 rounded-lg p-4 w-full max-w-2xl">
                ...
                <div className="flex flex-col gap-2">
                    <button
                        ...
                        disabled={uploading}
                        className="flex items-center justify-center gap-2 bg-gradient-to-r from-purple-600 via-purple-500 to-blue-500 hover:from-purple-700 hover:via-purple-600 hover:to-blue-600 disabled:from-gray-600 disabled:to-gray-700 text-white font-medium py-2.5 px-5 rounded-lg transition-all shadow-lg shadow-purple-500/20"
                    >
                    {uploading ? (
                        <>
                            <Loader className="w-5 h-5 animate-spin" />
                            <span>{currentStep || 'Traitement...'}</span>
                        </>
                    ) : (
                        <>
