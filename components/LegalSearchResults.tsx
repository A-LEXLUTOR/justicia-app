...
export const LegalSearchResults: React.FC<LegalSearchResultsProps> = ({ query, onResultsFound }) => {
  ...
  if (isLoading) {
    return (
      <div className="flex items-center justify-center p-6 bg-gradient-to-br from-purple-50 to-blue-50 rounded-lg border border-purple-200">
          ...
          >
            <div className="flex items-start justify-between">
              ...
              <a
                ...
                className="ml-4 px-4 py-2 bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded-lg hover:from-purple-700 hover:to-blue-700 transition-all duration-200 flex items-center space-x-2 text-sm font-medium"
              >
                <span>Consulter</span>
